$(document).ready(function () {
 ...
 $(document).ready(function() {
    ...
    $('#signup_form').validate({
        rules: {
            question_test: {required: true} 
        },
        messages: {
            first_name: {required: "Please enter question."}
        },
...
//        },
        ...
        submitHandler: function (form) {
            ...
            $('#loginLoader').show();
            $.ajax({
                url: APP_URL + "comprehenddata",
                data: new FormData($("#question_form")[0]),
                dataType: 'json',
                async: true,
                type: 'post',
                processData: false,
    ...
    $('#code_conduct_form').validate({
        ...
        messages: {
            code_of_conduct: {required: "Please agree Terms & Conditions."}
        },
        errorPlacement: function (error, element) {
