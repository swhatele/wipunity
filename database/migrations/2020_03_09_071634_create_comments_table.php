...
class CreateCommentsTable extends Migration
{
    ...
    public function up()
    {
        DB::unprepared('CREATE TABLE comments (
            ...
            PRIMARY KEY (`id`),
            INDEX `idx_comments_user_id` (`user_id` ASC),
            INDEX `idx_comments_discussion_id` (`discussion_id` ASC),
            INDEX `idx_comments_discussion_reply_id` (`discussion_reply_id` ASC),
