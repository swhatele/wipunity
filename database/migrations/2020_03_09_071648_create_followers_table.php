...
class CreateFollowersTable extends Migration
{
    ...
    public function up()
    {
        DB::unprepared('CREATE TABLE followers (
            ...
            PRIMARY KEY (`id`),
            INDEX `idx_followers_user_id` (`user_id` ASC),
            INDEX `idx_followers_discussion_id` (`discussion_id` ASC),
            INDEX `idx_followers_created_at` (`created_at` ASC))
