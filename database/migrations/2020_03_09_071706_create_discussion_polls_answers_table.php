...
class CreateDiscussionPollsAnswersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared('CREATE TABLE discussion_polls_answers (
            ...
            PRIMARY KEY (`id`),
            INDEX `idx_discussion_polls_answers_user_id` (`user_id` ASC),
            INDEX `idx_discussion_polls_answers_discussion_id` (`discussion_id` ASC),
            INDEX `idx_discussion_polls_answers_poll_id` (`poll_id` ASC),
            INDEX `idx_discussion_polls_answers_answer_id` (`answer_id` ASC),
            INDEX `idx_discussion_polls_answers_created_at` (`created_at` ASC))
    ...
    {
        Schema::dropIfExists('discussion_polls_answers');
    }
}
