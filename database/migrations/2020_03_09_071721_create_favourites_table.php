...
class CreateFavouritesTable extends Migration
{
    ...
    public function up()
    {
        DB::unprepared('CREATE TABLE favourites (
            `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
            `user_id` BIGINT NOT NULL,
            `discussion_id`  BIGINT NULL,
            `discussion_reply_id`  BIGINT NULL,
            `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
            `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
            PRIMARY KEY (`id`),
            INDEX `idx_favourites_user_id` (`user_id` ASC), 
            INDEX `idx_favourites_discussion_id` (`discussion_id` ASC),
            INDEX `idx_favourites_discussion_reply_id` (`discussion_reply_id` ASC),
            INDEX `idx_favourites_created_at` (`created_at` ASC))
