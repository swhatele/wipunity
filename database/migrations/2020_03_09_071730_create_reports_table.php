...
class CreateReportsTable extends Migration
{
    ...
    public function up()
    {
        DB::unprepared('CREATE TABLE reports (
            `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
            `user_id` BIGINT NOT NULL,
            `discussion_id` BIGINT DEFAULT NULL, 
            `discussion_reply_id` BIGINT DEFAULT NULL,
            `discussion_comment_id` BIGINT DEFAULT NULL,
            `report_reason_id` INT NOT NULL,
            `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP,
            `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
            PRIMARY KEY (`id`),
            INDEX `idx_reports_user_id` (`user_id` ASC),
            INDEX `idx_reports_discussion_id` (`discussion_id` ASC),
            INDEX `idx_reports_discussion_reply_id` (`discussion_reply_id` ASC),
            INDEX `idx_reports_discussion_comment_id` (`discussion_comment_id` ASC),
            INDEX `idx_reports_report_reason_id` (`report_reason_id` ASC),
            INDEX `idx_reports_created_at` (`created_at` ASC))
